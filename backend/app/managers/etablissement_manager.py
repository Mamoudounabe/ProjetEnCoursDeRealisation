...
class EtablissementManager:
    ...
    @staticmethod
    def get_comp_universite555(nomuniversites: List[str], anneesActuelles: List[str]) -> List[Dict[str, Any]]:
        query = """
    ...
    @staticmethod
    def get_comp_universite(nomuniversitestrois: List[str], anneeactuelle: List[str]) -> List[Dict[str, Any]]:
        query = """
            MATCH (e:Etablissement)
            WHERE ANY(nom IN $nomuniversites WHERE e.etablissement CONTAINS nom)
