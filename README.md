...
```
cd existing_repo
git remote add origin https://gitlabvigan.iem/groupe4/rapport.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlabvigan.iem/groupe4/rapport/-/settings/integrations)
